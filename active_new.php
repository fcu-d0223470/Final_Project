...
<!-- [[ contents]] -->
		<div id="contents"><div id="contents-inner">
				<div id="active-head">
					<a href="active_new.php"  ><input class="button-on"  type="submit"  value="最新活動"></a>
                ...
                echo "<div id='navi-bar'><ul>";
                    ...
                    if ($page > 1)
                    echo "<li> <a href='active_new.php?page=". ($page - 1) . "'>上</a> </li>";
                    ...
                    for ($i = 1; $i <= $total_pages; $i++)
                    {
                        if ($i == $page)
                            ...
                            echo "<li><a href='active_new.php?page=$i'>$i</a> </li>";		
                    }
			
                    if ($page < $total_pages)
                        echo "<li> <a href='active_new.php?page=". ($page + 1) . "'>下</a> </li></ul>";
