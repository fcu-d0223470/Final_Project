<?php
    ...
    //執行 SQL 命令
    $sql="SELECT *,task_introduction FROM task,have WHERE task_number=have_number and have_id='$user_id' and have_story_part=1 and have_flag=1 ORDER BY have_date DESC";  
...
<!-- [[ contents]] -->
		<div id="contents"><div id="contents-inner">
                ...
                <div id="active-head"> 
                    ...
                    <a href="member_bag.php"    ><input class="button-on"  type="submit"  value="我的背包"></a>                     
				</div>
		...
		<?php
            if($total_records >= 1){
                ...
                echo "<div id='navi-bar'><ul>";
                    ...
                    if ($page > 1)
                    echo "<li> <a href='member_bag.php?page=". ($page - 1) . "'>上</a> </li>";
                    ...
                    for ($i = 1; $i <= $total_pages; $i++)
                    {
                        if ($i == $page)
                            ...
                            echo "<li><a href='member_bag.php?page=$i'>$i</a> </li>";		
                    }
			
                    if ($page < $total_pages)
                        echo "<li> <a href='member_bag.php?page=". ($page + 1) . "'>下</a> </li></ul>";
