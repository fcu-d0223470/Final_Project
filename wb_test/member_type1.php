<?php
    ...
    //執行 SQL 命令
    $sql="SELECT *,task_introduction FROM task,have WHERE task_show=1 and task_number=have_number and have_id='$user_id' and have_story_part=1 and task_type=1 ORDER BY task_date DESC";  
...
<html>
    <head>
        ...
        <title>會員專區->主線活動</title>
        
        <meta name="description" content="" />
        <meta name="keywords" content="" />
        <meta name="viewport" content="width=device-width, initial-scale=1">
        
        <link rel="stylesheet" type="text/css" href="common/styles/member_active.css" />
...
<!-- [[ contents]] -->
		<div id="contents"><div id="contents-inner">
				<div id="active-user">
                    <a href="member_new.php" ><input class="user-on"    type="submit"  value="普通會員"></a>
                    <a href="developer.php"  ><input class="user-off"   type="submit"  value="高級會員"></a>
                </div>
                <div id="active-head"> 
					<a href="member_new.php"    ><input class="button-off" type="submit"  value="最新活動"></a>
					<a href="member_hot.php"    ><input class="button-off" type="submit"  value="熱門活動"></a>
					<a href="member_type1.php"  ><input class="button-on"  type="submit"  value="主線活動"></a>
					<a href="member_type2.php"  ><input class="button-off" type="submit"  value="支線活動"></a>
					<a href="member_type3.php"  ><input class="button-off" type="submit"  value="限時活動"></a> 
                    <a href="member_bag.php"    ><input class="button-off" type="submit"  value="我的背包"></a>
				</div>
                ...
                echo "<div id='navi-bar'><ul>";
                    ...
                    if ($page > 1)
                    echo "<li> <a href='member_type1.php?page=". ($page - 1) . "'>上</a> </li>";
                    ...
                    for ($i = 1; $i <= $total_pages; $i++)
                    {
                        if ($i == $page)
                            ...
                            echo "<li><a href='member_type1.php?page=$i'>$i</a> </li>";		
                    }
			
                    if ($page < $total_pages)
                        echo "<li> <a href='member_type1.php?page=". ($page + 1) . "'>下</a> </li></ul>";
